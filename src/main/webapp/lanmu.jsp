...
<div class="top">
    <div class="wt1080">
        <div class="fl">
            <a href="index.jsp">洋店首页</a>&emsp;|&emsp;请&emsp;<a href="show.jsp" style="color: #ff9900">登陆</a>&emsp;或&emsp;<a href="show.jsp">立即注册</a>
        </div>
        <div class="fr">
            <ul>
...
<div class="wt1080 header">
    ...
    <div class="search fl">
        ...
        <p>
            <a href="show.jsp" class="current">可莱丝</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="show.jsp">森田药妆</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="show.jsp">Montagne jeunesse</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="show.jsp">丽得姿</a>
        </p>
    </div>
            ...
            <li>
                <a href="lanmu.jsp"><span>母婴专区</span></a>
                    <div class="details">
                                    ...
                                    <div class="item">
                                        <p class="title"><a href="show.jsp">奶粉</a></p>
                                        <div class="ctgnamebox">
                                            <a href="liebiao.jsp">爱他美</a>
                                            <a href="liebiao.jsp">爱他美</a>
                                            <a href="liebiao.jsp">爱他美</a>
...
<div class="index_banner minWidth" id="focus">
    <ul>
        <li style="background:url(./image/bg2.png) no-repeat center;height: 452px;"><a href="show.jsp" title="" target="_blank"></a></li>
        <li style="background:url(./image/bg2.png) no-repeat center;height: 452px;"><a href="show.jsp" title="" target="_blank"></a></li>
    </ul>
</div>
<div class="clear"></div>
...
<div class="content">
    ...
    <div class="wt1080 tuijian">
        ...
        <div class="shangping">
            <ul>
                <li>
                    <div class="fl pic"><a href="show.jsp"><img src="image/product2.png"></a></div>
                    <div class="fl dd">
                        <h1><a href="show.jsp">三洋一次性防溢乳垫</a></h1>
                ...
                <li>
                    <div class="fl"><a href="show.jsp"><img src="image/product2.png"></a></div>
                    <div class="fl dd">
                        <h1><a href="show.jsp">三洋一次性防溢乳垫</a></h1>
                        <p class="one">柔软高吸收<br/>立体弧形贴合乳房</p>
                        <p class="two"><span>￥<span style="font-size: 22px;">89.00</span></span><font>￥128.00</font></p>
        ...
        <div class="ware wt1080">
            <div class="ware_top">
                <span>面霜乳液</span>
                <a href="liebiao.jsp">更多&gt;&gt;</a>
            </div>
            <div class="ware_bottom">
                <ul>
                    <li>
                        <div class="pic"><a href="show.jsp"><img src="image/product3.png"></a></div>
                        <p style="margin-bottom: 10px;"><a href="show.jsp">原装【贝贝自营】惠氏S-26金装爱儿乐婴儿配方奶粉 1段 900克*2</a></p>
                        <p><span class="one">￥<span style="font-size: 22px;">336.00</span></span><span class="two">￥336.00</span></p>
                        <div class="qianggou"><a href="show.jsp">立即抢购</a></div>
                    </li>
                    <li>
                        <div class="pic"><a href="show.jsp"><img src="image/product6.png"></a></div>
                        <p style="margin-bottom: 10px;"><a href="show.jsp">原装【贝贝自营】惠氏S-26金装爱儿乐婴儿配方奶粉 1段 900克*2</a></p>
                        <p><span class="one">￥<span style="font-size: 22px;">336.00</span></span><span class="two">￥336.00</span></p>
                        <div class="qianggou"><a href="show.jsp">立即抢购</a></div>
                    </li>
...
<div class="footer">
    <div class="wt1080" style="position: relative">
        <div class="a_footer">
            <div class="left">
                <a href="show.jsp"><img src="image/logo.png"></a>
                <p class="lianxi">
                    <a href="show.jsp"><img src="image/weixin.png"></a>
                    <a href="show.jsp"><img src="image/weibo.png"></a>
                    <a href="show.jsp"><img src="image/QQ.png"></a>
